...
sub run {
    ...
    rmt_server_setup;
    enable_all_modules;
    enable_multiple_products;
    disable_multiple_products;
    enable_by_product;
    enable_by_repo_id;
    mirror_repos;
    import_smt_data;
...
sub mirror_repos {
    ...
    assert_script_run("rmt-cli disable product sle-module-legacy/15/x86_64");
    # cleanup the downloaded files
    assert_scrip_run("rmt-cli repos clean");
}
